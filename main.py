...
mcmc_m1vphi2 = MCMC(model_class=M1VPHI2, nthreads=5, ndim=1, lower_bound=-1,
                    upper_bound=1)
mcmc_m1vphi24 = MCMC(model_class=M1VPHI24, nthreads=5, ndim=2, lower_bound=-3,
                    upper_bound=3)
mcmc_m1vexp = MCMC(model_class=M1VEXP, nthreads=5, ndim=2, lower_bound=-5,
                    upper_bound=5)

mcmc_m2vphi2 = MCMC(model_class=M2VPHI2, nthreads=5, ndim=1, lower_bound=-0.5,
                    upper_bound=0.5)
mcmc_m2vphi24 = MCMC(model_class=M2VPHI24, nthreads=5, ndim=2, lower_bound=-4,
                    upper_bound=4)
mcmc_m2vexp = MCMC(model_class=M2VEXP, nthreads=5, ndim=2, lower_bound=-5,
                    upper_bound=5)

mcmc_m3vphi2 = MCMC(model_class=M3VPHI2, nthreads=5, ndim=1, lower_bound=-0.5,
                    upper_bound=0.5)
mcmc_m3vphi24 = MCMC(model_class=M3VPHI24, nthreads=5, ndim=2, lower_bound=-4,
                    upper_bound=4)
mcmc_m3vexp = MCMC(model_class=M3VEXP, nthreads=5, ndim=2, lower_bound=-5,
                    upper_bound=5)
